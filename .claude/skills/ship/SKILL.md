---
name: ship
description: Finish a pgsrip change. Check that the knowledge files are still correct, run all checks, make the commits, push, and open the draft PR. Use when the user asks to commit, push, open a PR, or finish or ship the work.
---

# Ship

Follow `CONTRIBUTING.md` for the branch, commit, and PR rules. Do not copy them here.
...
3. Also check:
   ...
   - The commands in `CONTRIBUTING.md`, if you changed the tools.
